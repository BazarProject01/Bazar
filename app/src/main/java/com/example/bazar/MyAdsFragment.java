...
private  MyTabsViewPageAdapter myTabsViewPagerAdapter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState){
        ...
        myTabsViewPagerAdapter = new MyTabsViewPageAdapter(fragmentManager, getLifecycle());
    ...
    public class MyTabsViewPageAdapter extends FragmentStateAdapter{
        public MyTabsViewPageAdapter(@NonNull FragmentManager fragmentManager, @NonNull Lifecycle lifecycle) {
