...
public class ProfileEditAcrivity extends AppCompatActivity {
    ...
    private ActivityProfileEditAcrivityBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityProfileEditAcrivityBinding.inflate(getLayoutInflater());
        ...
        ref.putFile(imageUri)
                ...
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Utils.toast(ProfileEditAcrivity.this, "Failed to upload profile due to " +e.getMessage());
                    }
                });
    }
    private void  updateProfileDb(String imageUri){
        ...
        if(imageUri != null)
        {
            hashMap.put("profileImageUrl", ""+imageUri);
        }
        ...
        reference.child(firebaseAuth.getUid())
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Log.d(TAG, "onSuccess: InfoUpdated");
                        progressDialog.dismiss();
                        Utils.toast(ProfileEditAcrivity.this, "Profile Updated...");
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Log.e(TAG, "onFailure: ",e );
                        progressDialog.dismiss();
                        Utils.toast(ProfileEditAcrivity.this, "Failed to update info due to " + e.getMessage());
                    }
                });
    }
        ...
        ref.child(firebaseAuth.getUid())
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        String myUserType = ""+ snapshot.child("userType").getValue();
                        ...
                        try {
                            ...
                            Glide.with(ProfileEditAcrivity.this)
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if(itemId == 1)
                {
                    ...
                    {
                        requestCameraPermisions.launch(new String[]{Manifest.permission.CAMERA});
                    } else {
                        requestCameraPermisions.launch(new String[]{Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE});
                    }
    ...
    private ActivityResultLauncher<String[]> requestCameraPermisions = registerForActivityResult(
            ...
            new ActivityResultCallback<Map<String, Boolean>>() {
                ...
                public void onActivityResult(Map<String, Boolean> result) {
                    ...
                    if(areAllgranted){
                        ...
                        Log.d(TAG, "onActivityResult: Denied");
                        Utils.toast(ProfileEditAcrivity.this, "Camera or Storage or both permissions denied...");
                    }
                }
            }
    );
            ...
            new ActivityResultCallback<Boolean>() {
                ...
                public void onActivityResult(Boolean isGranted) {
                    ...
                    if(isGranted)
                    {
                        ...
                        Utils.toast(ProfileEditAcrivity.this, "Storage permission denied..!" );
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        ...
                        Utils.toast(ProfileEditAcrivity.this, "Canclled...");
                    }
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    if( result.getResultCode() == Activity.RESULT_OK)
                    {
                        ...
                        Log.d(TAG, "onActivityResult: Image from gallery picked"+ imageUri);
