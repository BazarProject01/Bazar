...
import com.example.bazar.databinding.ActivityLoginPhoneBinding;
...
private static final  String TAG =  "LOGIN_PHONE_TAG";
    ...
    private void validateData(){
        ...
        {
            Utils.toast(this, "Please enter phone code number:" );
        }
        else{
    ...
    private void  phoneLoginCallBack(){
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationCompleted(@NonNull PhoneAuthCredential credential) {
                ...
                signinWithphoneAuthCrendital(credential);
            }
    ...
    private void signinWithphoneAuthCrendital(PhoneAuthCredential credential){
        Log.d(TAG, "signinWithphoneAuthCrendital: ");
        ...
        firebaseAuth.signInWithCredential(credential)
                .addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                    ...
                    public void onSuccess(AuthResult authResult) {
                        ...
                        {
                            Log.d(TAG, "onSuccess: Nev user, Account created...");
                            updateUserInfoDb();
